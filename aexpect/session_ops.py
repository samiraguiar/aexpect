...
def get_atime(session, path):
    ...
    :rtype: str
    """
    return stat(session, path, fmt="%X")


def get_mtime(session, path):
    """
    ...
    :rtype: str
    """
    return stat(session, path, fmt="%z")


def get_ctime(session, path):
    """
    ...
    :rtype: str
    """
    return stat(session, path, fmt="%y")
...
def get_size(session, path):
    ...
    :rtype: int
    """
    return int(stat(session, path, fmt="%s"))
